    ...
    <main>
      ...
      <div class="telephone-container">
        ...
        <div class="input-telephone">
          <input type="tel" id="telephone" placeholder="Entrez votre numéro" />
        </div>
      </div>
      <div class="email-verif-container">
        <h2>Vérification de l'adresse e-mail :</h2>
        <div class="bouton-verif">
          <script src="../component/BoutonBleu.js"></script>
          <div id="boutonContainer2"></div>
          <script>
            document.getElementById("boutonContainer2").innerHTML = BoutonBleu(
