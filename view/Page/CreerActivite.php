...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="upload-container">
                <label class="upload-box"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <script>
        ...
        // Sélection des dates et heures avec Flatpickr
        flatpickr("#dates", {
            mode: "multiple",
            enableTime: true,
            noCalendar: false,
        ...
        async function submitActivityData() {
            try {
                ...
                // Ajouter les thèmes comme tableau (pas en JSON string)
                if (themes.length > 0) {
